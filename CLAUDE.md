...
This repository is the **strategy, brand, and production brain** of a podcast hosted by **Mrinal Wahal**: a Hinglish, **first-principles analytical** interview show about **power, incentives, and freedom** (from an anarcho-capitalist / classical-liberal conviction). **Two pillars, sequenced: Pillar 1 (the launch beachhead) = the politics of money** (monetary theory — money, inflation, central banking, sound money); **Pillar 2 (planned, host-led) = AI / deep learning**, the host's own expertise, analysed through the same lens. Felt topics (inflation, demonetization, the digital rupee; and later, everyday AI) are **on-ramps to first principles**, never the destination. **Launch narrow on money; broaden into AI once the beachhead lands.** It is not a software project — the deliverables are specifications, episode material, and judgment.
...
**Always:** segue from a felt topic **into first principles** (money now, AI later); **steelman the statist first**, then earn the radical (sound-money/ancap) conclusion *when the argument earns it*; pro-market *not* pro-business (separate markets from incumbents); **concede our own side's hard problems** (deflation, volatility, panics); translate all jargon (the "smart 15-year-old" test); anchor claims and **verify live stats the week of recording**.
...
- **Intellectual core = a first-principles analytical lens on power, incentives & freedom.** Launch beachhead = **monetary theory (Pillar 1)**; planned second pillar = **AI / deep learning (Pillar 2, the host's expertise)**. **Stance = anarcho-capitalist / classical-liberal** (radical in substance, inviting in method).
...
- **Remit** = the analytical lens on power/incentives/freedom — **money first (Pillar 1), AI later (Pillar 2)** — treated as *ideas & first principles*, felt topics as on-ramps; never stock/crypto tips or AI tool-tips/hype.
...
docs/craft.md            ← interview technique + Dos/Don'ts
