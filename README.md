# Mrinal Wahal — Podcast

The strategy, brand, and production brain of a **Hinglish**, **anarcho-capitalist** interview show whose spine is **monetary theory** — money, inflation, central banking, sound money — opening onto the wider case for free markets and liberty. Hosted by **Mrinal Wahal** (YouTube channel = "Mrinal Wahal"), interviewing expert guests. Felt topics (inflation, demonetization, the digital rupee, gold) are **on-ramps to theory**, never the destination.

> **North Star:** *Explain monetary theory plainly — what money is, why it loses value, and why the state shouldn't control it — to a general, skeptical, statist Indian audience.*
...
docs/
  charter.md             ← SOURCE OF TRUTH: purpose, non-negotiables, decision rule, litmus test
  monetary-theory.md     ← the intellectual spine: core thesis, canon, Indian on-ramps
  brand.md               ← brand & positioning spec (voice, audience, positioning)
  ideology.md            ← ancap stance, method, the honesty engine + liberty canon
...
episodes/
  README.md              ← season slate + topic bank + guest roster
  01-monetary-theory/
    prep-sheet.md        ← printable one-pager for the recording
    notes.md             ← theory, question bank, guest brief
```
...
- **What it is:** an anarcho-capitalist show about **monetary theory** — what money is, why it loses value, who controls it. Felt topics are on-ramps; the destination is theory.
...
- **Ep. 1 — *Monetary theory: what is money*:** open on a specific story (e.g. cigarettes becoming money in a POW camp), then the Cantillon effect and the question: should anyone have the power to print money?

## Honest take, up front
1. **"Ancap talking to socialist India" is a strong identity with one trap:** if you preach the pure doctrine you reach the converted, not the persuadable. Be **radical in substance, inviting in method** — start from felt pain, steelman the statist, *earn* the conclusion. That device (the ancap who takes the socialist seriously) is your edge.
...
5. **Interviewing a friend for Ep. 1 → cosiness risk.** Your job is the **relentless translator** — [interview-craft.md](docs/interview-craft.md) + the [prep sheet](episodes/01-monetary-theory/prep-sheet.md) are built against it.
...
- [ ] One **RSS feed** → YouTube (primary) + Spotify + Apple + Amazon/JioSaavn.
- [ ] Line up a **clips editor**; set up the clips workflow.
...
- [ ] Prep Ep. 1 from the [prep sheet](episodes/01-monetary-theory/prep-sheet.md); send your guest the brief in [notes](episodes/01-monetary-theory/notes.md).
