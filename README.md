...
The strategy, brand, and production brain of a **Hinglish**, **anarcho-capitalist** interview show whose spine is the **politics of money** (monetary theory) — who controls money, how that control is power, and who it robs — opening onto the wider case for free markets and liberty. Hosted by **Mrinal Wahal** (YouTube channel = "Mrinal Wahal"), interviewing expert guests. Felt topics (inflation, demonetisation, the digital rupee, gold) are **on-ramps to theory**, never the destination.
...
- **What it is:** an anarcho-capitalist show about the **politics of money** — why money loses value, who controls it, and who that robs. Felt topics are on-ramps; the destination is theory. The monetary core is a **2-episode arc** (the tax → the control & the way out), then the same lens extends to the wider politics of freedom.
